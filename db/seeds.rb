...
User.create name: 'Manuel', status: :active, kind: :salesman, email: 'salesman2@cubika.digital', password: 123456
User.create name: 'Marcos', status: :active, kind: :manager, email: 'brunocorream@gmail.com', password: 123456
